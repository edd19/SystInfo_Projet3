\documentclass[aps,10pt]{article4-1}
...
\quad De plus on constate que pour writev, le temps moyen par écriture est moindre pour un fichier de grande taille que pour un fichier de petite taille. Au contraire de lseek+write où le temps moyen est supérieur pour un fichier de grande taille. Une dernière observation est que le temps pris pour écrire augmente avec la taille des blocs à écrire, ce qui est tout à fait normale.
...
\begin{figure}
	...
	\includegraphics[scale = 0.3]{readdir4.png}
